...
try {
    ...
    // Insere o cupom
    $stmt = $pdo->prepare("INSERT INTO cupons (codigo, salao_id, data_expiracao, valor_ressarcimento) VALUES (?, ?, ?, ?)");
    $stmt->execute([$codigo, $salao_id, $data_expiracao, $valor_ressarcimento]);
